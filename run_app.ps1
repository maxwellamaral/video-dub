...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$CurrentDir'; uv run uvicorn src.backend.app:app --reload --host 0.0.0.0 --port 8000" -WindowStyle Minimized
